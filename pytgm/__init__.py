__all__ = ['random','num','integer','binary','choose','seq','modify','shuffle','duplicate','remove','file','readLine','modLine','graphics','cls','color','res','bold','italic','underline','terd','geky','click','sound','file','frequency','big','small','board','boards','add','remove','modify','LocalServer','server','client','b64','table_','tableGen','tableSet','encode','decode']
...
import .LocalServer as LocalServer
